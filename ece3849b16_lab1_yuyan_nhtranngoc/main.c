...
/**
 * Main function, to run indefinitely
 * @return None
 */
int main(void)
{
...
/**
 * Process button inputs and put them in an array.
 */
void processButtons()
{
...
/**
 * Draw the grid for oscilloscope
 */
void drawGrid()
{
	int i = 0;
...
/**
 * Draw trigger line always at the center of the screen
 */
void drawTrigger()
{
 ...
 * @param 	short*	_InputBuffer		Pointer to the input signal buffer
 */
...
/**
 * Find a sample matching the trigger requirements
 * @param 	int 	direction 		Direction 0 for slope down, 1 for slope up
 * @param	int 	triggerValue	Trigger value to search with
 * @return 	int 	triggerIndex	Trigger index matching the requirements
 */
...
/**
 * Measure CPU Load
 * @return 	unsigned long	i 		Load percentage
 */
...
/**
 * Initialize SPI Interface for display at 3.5MHz
 */
...
/**
 * Timer0 ISR. This one is being used to send a pulse to make sure the program is running
 */
void Timer0AISR()
{
...
/**
 * Timer1 ISR. This one is used to calculate CPU Load
 */
void Timer1AISR()
{
...
/**
 * Timer2 ISR. This one is used to scan the button inputs
 */
void Timer2AISR()
{
...
/**
 * ADC0 ISR. This one is used to read the signal input.
 */
void ADC_ISR(void)
{
 ...
 * @param 	char* 	_String			Pointer to string to calculate width
 * @return 	int 	count 			Width of the string
 */
...
/**
 * Attempts to center given _String at target _Coordinate
 * @param 	int 	_Coordinate 	x-coordinate to center the string at
 * @param	char*	_String			Pointer to string to center
 * @return 	int 	result 			Resulting x-coordinate
 */
...
/**
 * Wipe the screen by calling FillFrame() with 0
 */
void screenClean()
{
	FillFrame(0);
...
/**
 * Render the screen by pushing the buffer to the display
 */
void screenDraw()
{
